...
class Sharding:
    ...
    def distribute_articles_over_shards(self):
        ...
        # add for T-BERT to prevent distributing process cannot finish.
        unused_article_set_history = -1
        ...
        while len(consumed_article_set) < len(self.articles):
            ...
            # add for T-BERT to prevent distributing process cannot finish.
            if unused_article_set_history == len(unused_article_set):
                break
            unused_article_set_history = len(unused_article_set)
